...
class ASRBase:
    ...
    def __init__(self, lan, modelsize=None, cache_dir=None, model_dir=None, logfile=sys.stderr, device:str='auto', compute_type:str=None):
...
class FasterWhisperASR(ASRBase):
    ...
    def load_model(self, modelsize=None, cache_dir=None, model_dir=None, device:str='auto',compute_type:str=None):
...
#        logging.getLogger("faster_whisper").setLevel(logger.level)
        ...
        model = WhisperModel(model_size_or_path, device=device, download_root=cache_dir)
